        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <ScrollReveal>
            <div className="mx-auto max-w-3xl text-center">
              ...
              <TypewriterTitle text={t("serviceDevelopment.title")} />
              ...
              >
                <img src={sphereDevelopment} alt="Development crystal sphere" className="w-full h-full object-contain rounded-full drop-shadow-[0_0_30px_hsl(280,70%,50%,0.4)]" />
              </motion.div>
            </div>
          </ScrollReveal>
        </div>
